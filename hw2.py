...
#This assigment taught me about the sum function and the clean text function
#loops from java are a bit different in their methods of looping but still functions the same even if the termology is different
#
